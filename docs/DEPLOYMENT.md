...
export DJANGO_SETTINGS_MODULE=payroll_project.settings.production
python manage.py migrate
...
| Module | Use |
|--------|-----|
| `payroll_project.settings.development` | Local dev (`manage.py`) |
| `payroll_project.settings.production` | Gunicorn / Docker |
