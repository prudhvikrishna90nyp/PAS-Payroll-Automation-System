...
> Canonical numbered copy: [`backend/docs/08_ARCHITECTURE.md`](../backend/docs/08_ARCHITECTURE.md). This file is the same reference at the path requested for discovery from the repo root.
...
| Numbered architecture | [08_ARCHITECTURE.md](../backend/docs/08_ARCHITECTURE.md) |
