...
ESI, Professional Tax, and TDS are calculated via ``apps.compliance``
(Sprints 9.1–9.4).
"""
...
class EmployeeCalcResult:
    ...
    tds_calculation: object | None = None
...
def calculate_employee(
    *,
    ...
    # Structure-defined EE_PF / EE_ESI / PT / TDS lines are superseded by statutory engine rows.
    deduction_rows = [
    ...
    statutory_rows, pf_calc, esi_calc, pt_calc, tds_calc = statutory_component_rows(
        employee=employee,
        period=period,
    ...
    return EmployeeCalcResult(
        ...
        calculation_detail={
            ...
            'statutory': 'epf_esi_pt_tds_sprint_9_4',
            ...
            'tds': tds_calc.to_snapshot_dict() if tds_calc else {},
        },
    )
